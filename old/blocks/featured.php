...
class Emmis_Featured_Items_Content_Block extends Tenup_Content_Block {
	...
	?>
		<input type="hidden" name="tenup_content_blocks[<?php echo esc_attr( $row ); ?>][<?php echo esc_attr( $area ); ?>][<?php echo esc_attr( $column ); ?>][<?php echo esc_attr( $iterator ); ?>][type]" value="featured" />
		<p>
		...
		<p>
			<label for="tenup_content_blocks[<?php echo esc_attr( $row ); ?>][<?php echo esc_attr( $area ); ?>][<?php echo esc_attr( $column ); ?>][<?php echo esc_attr( $iterator ); ?>][show-date]">
				<input type="checkbox" name="tenup_content_blocks[<?php echo esc_attr( $row ); ?>][<?php echo esc_attr( $area ); ?>][<?php echo esc_attr( $column ); ?>][<?php echo esc_attr( $iterator ); ?>][show-date]" id="tenup_content_blocks[<?php echo esc_attr( $row ); ?>][<?php echo esc_attr( $area ); ?>][<?php echo esc_attr( $column ); ?>][<?php echo esc_attr( $iterator ); ?>][show-date]" <?php isset( $data['show-date'] ) ? checked( $data['show-date'], 'y' ) : ''; ?>/>
				Show Date
			</label>
		</p>
		<p>
			<label for="tenup_content_blocks[<?php echo esc_attr( $row ); ?>][<?php echo esc_attr( $area ); ?>][<?php echo esc_attr( $column ); ?>][<?php echo esc_attr( $iterator ); ?>][show-thumb]">
				<input type="checkbox" name="tenup_content_blocks[<?php echo esc_attr( $row ); ?>][<?php echo esc_attr( $area ); ?>][<?php echo esc_attr( $column ); ?>][<?php echo esc_attr( $iterator ); ?>][show-thumb]" id="tenup_content_blocks[<?php echo esc_attr( $row ); ?>][<?php echo esc_attr( $area ); ?>][<?php echo esc_attr( $column ); ?>][<?php echo esc_attr( $iterator ); ?>][show-thumb]" <?php isset( $data['show-thumb'] ) ? checked( $data['show-thumb'], 'y' ) : ''; ?>/>
				Show Thumbnails
			</label>
		</p>
		<p>
	...
	public static function clean_data( $data ) {
		...
		$new['show-date'] = isset( $data['show-date'] ) ? 'y' : '';
		$new['show-thumb'] = isset( $data['show-thumb'] ) ? 'y' : '';
	...
	public static function display( $data, $area ) {
		if ( isset( $data['manual'] ) && 'y' == $data['manual'] ) {
			...
			$cache_key = 'featured_list_' . $params;
			...
			if ( false === $post_ids ) {
				...
				if ( isset( $data['orderby-title'] ) && 'y' === $data['orderby-title'] ) {
					$posts = $featured_post_query->posts;
					...
					$post_ids = $featured_post_query->posts;
					wp_cache_set( $cache_key, $post_ids, '', MINUTE_IN_SECONDS * 30 );
				}
			}
		}

		if ( isset( $data['show-thumb'] ) && 'y' == $data['show-thumb'] ) {
			$class = 'module-features';
		} else {
			$class = 'module-topstories';
		}

		echo '<div class="module '. esc_attr( $class ) .'">';
